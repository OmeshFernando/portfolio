        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="relative bg-[#0a0118]/90 backdrop-blur-xl border border-blue-400/40 rounded-2xl p-6 hover:border-blue-300/70 transition-all duration-300 h-full">
                ...
                <div className="flex flex-wrap gap-3">
                  {category.items.map((item) => (
                    <Badge
                      key={item}
                      className="bg-blue-500/20 text-blue-200 border border-blue-400/50 hover:bg-blue-500/30 text-base px-4 py-2"
                    >
                      {item}
                    </Badge>
                  ))}
