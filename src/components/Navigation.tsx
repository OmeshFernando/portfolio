...
export function Navigation({ activeSection, setActiveSection }: NavigationProps) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-[#0a0118]/90 backdrop-blur-xl border-b border-blue-400/40"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="md:hidden text-white hover:bg-blue-500/20"
