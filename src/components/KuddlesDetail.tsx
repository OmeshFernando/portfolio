  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold leading-[1.28] mb-6 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent overflow-visible">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-blue-400/40 bg-[#0a0118]/60 p-6">
                  ...
                  <p className="text-gray-100 text-[15px] sm:text-base">Team Project (6 Members)</p>
              ...
              <div className="space-y-6">
                <div className="rounded-2xl border border-blue-400/40 bg-[#0a0118]/60 p-6">
                  ...
                  <div className="grid gap-2 text-gray-100 text-[15px] sm:text-base">
                    <div className="flex flex-col gap-1 rounded-xl border border-blue-500/10 bg-blue-500/5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                      <span>Frontend:</span>
                      <span className="text-blue-200">React Native</span>
                    </div>
                    <div className="flex flex-col gap-1 rounded-xl border border-blue-500/10 bg-blue-500/5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                      <span>Backend:</span>
                      <span className="text-blue-200">Node.js, Express</span>
                    </div>
                    <div className="flex flex-col gap-1 rounded-xl border border-blue-500/10 bg-blue-500/5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                      <span>Database:</span>
                    ...
                    <div className="flex flex-col gap-1 rounded-xl border border-blue-500/10 bg-blue-500/5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <span className="text-blue-200">Firebase (Authentication, Push Notifications)</span>
                    </div>
                    <div className="flex flex-col gap-1 rounded-xl border border-blue-500/10 bg-blue-500/5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between">
                      <span>Design & Collaboration:</span>
                      <span className="text-blue-200">Figma, GitHub</span>
                    </div>
                  </div>
                ...
                <div className="rounded-2xl border border-blue-400/40 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 p-6">
                  ...
                  <p className="text-gray-100 mt-2 text-[15px] sm:text-base">
                    Early wireframes were created to validate information architecture and user flows for both parent
                    and nanny experiences.
                  </p>
                <div className="mt-4 overflow-hidden rounded-xl border border-blue-400/40">
                  <img
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-100 text-[15px] sm:text-base">
